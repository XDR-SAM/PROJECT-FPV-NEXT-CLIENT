    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="col-span-1">
            <Link href="/" className="flex items-center gap-2">
              ...
              />
              <span className="text-xl font-bold text-white">Project FPV</span>
            </Link>
            <p className="mt-4 text-sm">
              Fly Safe, Share Often. Join the FPV drone community.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/blogs" className="text-sm transition-colors hover:text-white">
                  Blogs
                </Link>
              </li>
              <li>
                <Link href="/community" className="text-sm transition-colors hover:text-white">
                  Community
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 border-t border-gray-800 pt-8 text-center text-sm">
          <p>© 2025 Project FPV. Fly Safe, Share Often.</p>
        </div>
      </div>
    </footer>
  );
